...
char passenger1[50], passenger2[50], passenger3[50], passenger4[50], dest[10], tim[10], coupon[15], mClass1[20], mClass2[20], mClass3[20], mClass4[20], departure, purchase, package;
...
{ rDiscount=0.0;
 ...
 cout<<"\n\nYour flight is SAKSHAM AIRLINES-770 (RB 370)";
...
{ do
 ...
 cout<<"\n\n========== SAKSHAM WALIA A I R L I N E R E P O R T ==========";
